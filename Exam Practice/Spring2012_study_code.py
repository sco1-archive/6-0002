...
'''If there are a discrepancies in the code please refer to code
provided at the end of the practice exam. Both code samples are supposed to
be identical'''
...
class Cluster(object):
    ...
    def computeCentroid(self):
        ...
        for p in self.points:
            totVals += p.getAttrs()
        centroid = self.pointType('mean',totVals/float(len(self.points)),totVals/float(len(self.points)))
        return centroid
